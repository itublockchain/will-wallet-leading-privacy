...
contract handlerNonWithdrawMood is Test {
    will account;
    will Will;
    mapping (address => uint) public inheritorIndex;
    address[] public inheritors; //keep tracking the inheritors . 
    mapping (address => int) public inheritorCount;// this track how many time the inheritor get added in the contract
    uint public initcall = 1;//should always be 1;
...
contract hundlerWithdrawMood is StdCheats ,TestBase,StdUtils {}
