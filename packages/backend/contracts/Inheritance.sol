...
contract Inheritance {
    ...
    modifier onlyAccount() {
        require(msg.sender == address(this), "Only the Account can call this method.");
        _;
    }
    ...
    function addOrUpdateBeneficiary(address _beneficiary, uint256 _shares) external onlyAccount {
